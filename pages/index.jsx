        ...
        <div>
            ...
            {collectors && collectorFilters && (
                <TopCollectors
                    ...
                    setTopCollectorsFilter={setTopCollectorsFilter}
                />
            )}
            {howComponentData && (
                <How
                    title={howComponentData.title}
                    description={howComponentData.description}
                    items={howComponentData.items}
                    link={howComponentData.link}
                />
            )}
            {auctions && auctionFilters && (
                <Auctions
                    ...
                    setLiveAuctionsFilterValue={setLiveAuctionsFilterValue}
                />
            )}
            <Footer />
        </div>
